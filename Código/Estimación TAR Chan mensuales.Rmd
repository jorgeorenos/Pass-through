...
\delta_be_t*(0.016929\leq\Delta\%P_{t-1}\leq0.05409)+
...
|-----------------------------------------------------------|------------|--------------|
|$\Delta\%P_{t-1}$                                          |0.32442***  |2.62x10^{-6}  |
|$e_t$                                                      |0.10405     |0.211847      |
|$\delta_ae_t*(\Delta\%P_{t-1}<0.14%)$                      |-0.24938 .  |0.050216      |
|$\delta_be_t*(0.14%\leq\Delta\%P_{t-1}\leq0.83%)$          |-0.09395    |0.328551      |
|$\Delta\%P_{t}^{E}$                                        |0.23882***  |0.157320      |
|$\beta_4y_t^{brecha}$                                      |-0.02448    |0.000343      |
...
# Coeficiente del efecto traspaso en regímen de infalción alta

coef_alta <- 0.10405
coef_inercial <- 0.32442
choque <- 1
